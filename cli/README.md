...
cargo run -- $CLUSTER borrow --payer $KEYPAIR --ids-path $IDS_PATH --mango-group-name $MANGO_GROUP_NAME --margin-account $MARGIN_ACCOUNT --token-symbol $TOKEN --quantity $BORR
